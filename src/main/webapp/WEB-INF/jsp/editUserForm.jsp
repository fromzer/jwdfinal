...
<fmt:bundle basename="pagecontent">
    ...
    <div class="container">
        ...
        <div class="form-container">
            <form id="web-form" action="/home?command=saveChangeUserAccount&userId=${userData.id}" method="post">
                <h3>Update user info</h3>
                <fieldset>
                    <label for="login"><b>Login</b></label>
                    <input placeholder="Your Login" type="text" name="login" id="login" value="${userData.login}"
                ...
                <fieldset>
                    ...
                    <select id="role" name="role">
                        <option value="${userData.role.id}" selected>Choose...</option>
                        <option value="1">Administrator</option>
                        <option value="2">User</option>
                    </select>
                </fieldset>
                <fieldset>
                    <button name="submit" type="submit" id="web-form-submit" data-submit="...Sending">Save</button>
                </fieldset>
                <p class="center">Or <a href="/home?command=showAllUsers">Back</a> to user list</p>
            </form>
        </div>
    </div>
    </body>
